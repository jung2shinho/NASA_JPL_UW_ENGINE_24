...
The core components of LSTM are cell state and gates. Figure1 illustrates the mechanisms inside a LSTM unit, where i, f, g, and o denote the input gate, forget gate, cell candidate, and output gate, respectively. 
